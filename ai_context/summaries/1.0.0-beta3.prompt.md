...
Period: 1.0.0-beta3
Credited issues in this report: 97
...
- #3586311: Usage record page leaks context item content and grants links without access checks
- #3586315: Selector loads the entire catalog when an agent has no scope subscriptions
- #3586317: Documentation corrections: dependency requirements and AI module version
- #3586323: AiContextAgentSettingsTest fails with ai_agents 1.3.2+ due to hardcoded edit form path
- #3586331: CCC CI pipelines failing across MRs from new phpstan rules
...
- #3586301: Clean up CCC accessible interactive links and external links
- #3586303: Clean up CCC JavaScript filter feedback
- #3586310: [Meta] CCC cleanup from beta3 code review findings for beta3
...
- #3586283: Finalize Context Importer naming and review Extensions page UI/UX
...
- #3586299: Clean up CCC test and documentation consistency before rc1
- #3586300: Clean up CCC cacheability and access metadata
- #3586304: Clean up CCC form and table accessibility cleanup
- #3586305: Clean up CCC documentation and API consistency
- #3586306: Clean up CCC configuration policy checks
- #3586328: Add manage links to scope edit admin pages for certain scope links
...
- #3586293: Sprint 13 CCC roadmap updates, sprint planning, and issue triage
